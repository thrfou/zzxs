...
<div class="menu">
	<ul>
		<li class="menuout"><a id="highlight" href="<?php echo U('Index/best');?>">热门</a></li>
...
<div class="content-block">
<div class="col1">
<?php $_result=D('Nav')->nlist('3','1','-1','25','1000000','1','-1'); if($_result): $i=0;$page=$_result["page"];foreach($_result["news"] as $key=>$nlist):++$i;?><div class="block untagged" id="qiushi-<?php echo ($nlist["id"]); ?>">
<div class="author" style="height:30px;line-height:30px;margin:0;">
	...
	<div style="float:right;">
		<a href="<?php echo U('User/Index/index?uid='.$nlist['uid']);?>" target="_blank"><?php echo ($nlist["author"]); ?></a>&nbsp;&nbsp;
