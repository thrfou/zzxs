...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div style="width:100%; height:15px;color:#000;margin:0px 0px 10px;">
	  <div style="float:left;"><a href="<?php echo U('Index/stat');?>" target="main"><b>控制面板首页</b></a>&nbsp;&raquo;&nbsp;广告管理&nbsp;&raquo;&nbsp;<a href="<?php echo U('Ad/add');?>" style="color:red;font-weight:bold;">添加广告</a></div>
	</div>
	<table cellspacing="1" cellpadding="4" width="100%" align="center" style="border: 0 none !important; border-collapse: separate !important;empty-cells: show;margin-bottom: 0px;">
		<tr class="header" align="center">
			<td  width="30%" class="center">广告名字</td>
			<td  width="30%" class="center">前台调用地址</td>
			<td  width="20%" class="center">广告最后修改时间</td>
	...
	<ul id="list">
		<?php if($list != NULL): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style="list-style:none;">
					<table  id="table1" cellspacing="1" cellpadding="4" width="100%" align="center" style="border: 0 none !important; border-collapse: separate !important;empty-cells: show;margin-bottom: 0px;"> 
						<tr align="center" class="smalltxt">
							<td width="30%" class="altbg1 center"><?php echo ($vo["name"]); ?></td>
							<td width="30%" class="altbg2 center">&lt;YICMS_ad id="<?php echo ($vo["id"]); ?>"/&gt;</td>
							<td width="20%" class="altbg1 center"><?php echo (switchtime($vo["time"])); ?></td>
							<td width="10%" class="altbg2 center"><a href="<?php echo U('Ad/edit?id='.$vo['id']);?>" style="background:url(../Public/Images/admin/edit.png) no-repeat center center;padding:0px 40px;">&nbsp;</a></td>
							<td width="10%" class="altbg1 center"><a href="<?php echo U('Ad/del?id='.$vo['id']);?>" onclick="return confirm('提示：您确定要删除该广告吗？不可恢复！')" style="background:url(../Public/Images/admin/remove.png) no-repeat center center;padding:0px 40px;">&nbsp;</a></td>
						</tr>
					</table>
		...
		<?php else: ?>
			<li>
				<table  id="table1" cellspacing="1" cellpadding="4" width="100%" align="center" style="border: 0 none !important; border-collapse: separate !important;empty-cells: show;margin-bottom: 0px;"> 
					<tr align="center" class="smalltxt">
						<td class="altbg1" style="text-align:center;font-weight:bold;color:#E01558;padding:10px 0px;">暂时没有广告!请点击上面的添加按钮添加!^_^</td>
					</tr>
				</table>
			</li><?php endif; ?>	
	</ul>
